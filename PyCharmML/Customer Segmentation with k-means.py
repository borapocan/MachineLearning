...
it would be the same as guessing that each customer group would have certain age, income, education, etc, with multiple tests and experiments.
...
df["Clus_km"] = labels
df.head(5)
"""We can easily chekc the centroid values by averaging the features in each cluster."""
